...
# Full pipeline: patchprep → 4 AEs → 4 analyses → 16 classifications → 8 vis
...
echo ""
echo "======================================================================"
echo " STAGE 4 — Cross-classification visualization  (8 runs)"
echo "======================================================================"
